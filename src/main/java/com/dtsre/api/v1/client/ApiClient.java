...
import com.dtsre.api.v1.client.auth.Authentication;
import com.dtsre.api.v1.client.auth.HttpBasicAuth;
import com.dtsre.api.v1.client.auth.HttpBearerAuth;
import com.dtsre.api.v1.client.auth.ApiKeyAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  protected String basePath = "http://127.0.0.1:8855";
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    if (auth instanceof ApiKeyAuth) {
      ...
      authentications.put("API_KEY", new ApiKeyAuth("header", "API-KEY"));
    }
